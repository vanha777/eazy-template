...
async fn main() {
    ...
    //create mongo cilent
    let client_options = ClientOptions::parse("mongodb://root:examplepassword@localhost:27017/")
        .await
        .unwrap();
    ...
    //create mysql cilent
    let database_url = "mysql://root:examplepassword@localhost:3306/ladomana";
